    ...
    if (self = [super initWithCoder:aDecoder]) {
        ...
        [RACObserve(self, model.placemark) subscribeNext:^(CLPlacemark *placemark) {
            if (placemark) {
                ...
                self.textLabel.text = [NSString stringWithFormat:FORMATTED_ADDRESS, placemark.subThoroughfare, placemark.thoroughfare, placemark.locality, placemark.administrativeArea, placemark.postalCode];
            }
        }];
    }
    return self;
